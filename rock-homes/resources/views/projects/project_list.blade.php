        ...
        <div class="mt-3" >
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!--                <a href="{{ url()->previous() }}" class="btn btn-outline-primary rounded-pill btn-md waves-effect waves-light" >-->
                    <!--                    <i class="bx bx-arrow-back"></i>-->
                    <!--                    Back</a>-->
                    <!--                    <span class="col-sm-2"></span>-->
                    <!--                <a href="{{ route('projects.create') }}" class="btn btn-outline-primary rounded-pill btn-md waves-effect waves-light" >-->
                    <!--                    Add New Project</a>-->
                    <!--            </div>-->
                    <!--        </div>-->
                    <!--    </div>-->
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <a href="{{ route('projects.show',  $encryptId) }}" class="nav-link">
                                                        {{ !empty($project->client_name) ? $project->client_name : '' }} </span></a></td>
