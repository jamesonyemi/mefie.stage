                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="remember-forgot">
                                ...
                                class="forgot-password" style="color: #f2682b !important">Forgot password?</a>
                            </div>
                        </div>
                        <button type="submit" class="login-btn" style="background-color: #293754 !important">Login</button>
