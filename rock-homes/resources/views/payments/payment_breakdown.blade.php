                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="mb-0 font-size-18">
                                <fieldset>
                                    <legend>Payment Analysis</legend>
                                    <b><span class="text-primary">  
                                       <span class="icon">
                                        &nbsp; <small>|</small> &nbsp;
                                            <i style="font-size: 16px; font-weight:bold">
                                                <small>Budget Est. :</small>
                                                 GH₵ {!! number_format($estimatedBudget) !!}
                                                </i> 
                                                 &nbsp; <small>|</small> &nbsp;
                                            <i style="font-size: 16px; font-weight:bold">
                                                <small>Amt Spent :</small> 
                                                GH₵ {!! number_format($pay)  !!}</i> 
                                                &nbsp; <small>|</small> &nbsp;
                                            <i style="font-size: 16px; font-weight:bold">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td> --}}
                                                    ...
                                                    {{-- <a href="#" class="mr-2 d-inline-block text-success" 
