                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" valign="middle" width="100%" style="background: linear-gradient(to right,#bf958b 0%,#182644 100%); width: 100%; padding: 20px; min-width:100%; color: #ffffff">
                                                    ...
                                                    <img src="{!!  asset(config('app.app_logo')) !!}" alt="{!! config('app.name') !!}-logo" width="120" height="35" style="width: 120px; height: 35px; vertical-align: middle; clear: both; width: auto; max-width: 100%;">                                                    @else
                                                    <p>
