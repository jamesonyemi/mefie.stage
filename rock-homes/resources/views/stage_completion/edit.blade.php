                    ...
                    <div >
                        <span>
                            <i class="badge badge-default">Project Owner:</i>
                               <i class="badge badge-primary"> {{ ($r->full_name) ? $r->full_name : ''  }} </i>
                        </span>
                    </div>
                    <div>
                        <span>
                            <i class="badge badge-default">Project Budget:</i>
                            <i class="badge badge-primary">{{ !empty($r->project_budget) ? number_format($r->project_budget, 2) : 'Not Specified yet'  }} </i>
                        </span>
                    </div>
                </div>
                <div class="col-md-8">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="status_id" name="status_id" class="form-control custom-select" required>
                                    ...
                                    @foreach ($project_status as $key => $status)
                                        @if ( !empty($r->status_id) )
                                            <option value="{{ $key }}" {{ old('phase_id', in_array($key,[$key]) ? $r->status_id : 'null') === $key ?
