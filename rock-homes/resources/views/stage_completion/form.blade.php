                    ...
                    <div class="col-1"></div>
                        <div class="form-group col-md-4">
                            <label for="comment">Materials Purchased</label>
                                <textarea name="matpurchased" id="matpurchased" cols="32" rows="5" class="form-control"  required ></textarea>
                            </div>
                            <div class="form-group col-md-2"></div>
                            <div class="form-group col-md-4">
                                <label for="comment">Details of Amount Spent</label>
                                    <textarea name="amtdetails" class="form-control" id="amtdetails" cols="32" rows="5"  required ></textarea>
                                </div>
                        </div>
