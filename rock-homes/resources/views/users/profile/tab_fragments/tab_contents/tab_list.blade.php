  ...
  <div class="row">
      <div class="col-lg-4">
          ...
          <div class="card user-info-box mb-30">
              ...
              <div class="card-body">
                  <ul class="mb-0 list-unstyled">
                      <li class="d-flex">
                          <i class="mr-2 bx bx-briefcase"></i>
                      ...
                      <li class="d-flex">
                          <i class='mr-2 bx bxs-graduation'></i>
                      ...
                      <li class="d-flex">
                          <i class='mr-2 bx bx-home-circle'></i>
          ...
          <div class="card user-photos-box mb-30">
              ...
              <div class="card-body">
                  <ul class="flex-wrap mb-0 list-unstyled d-flex">
                      <li>
                          <a href="#">
      ...
      <div class="col-lg-8">
          <div class="post-share-content mb-30">
              ...
              <div class="pt-4 mt-4 post-share-footer d-flex align-items-center justify-content-between">
          ...
          <div class="timeline-story-content">
              <div class="card mb-30">
                  ...
                  <div class="card-body">
                      ...
                      <div class="mt-4 feedback-summary">
              ...
              <div class="card mb-30">
                  ...
                  <div class="card-body">
                      ...
                      <div class="mt-3 feedback-summary">
  ...
  <div class="card user-friends-box mb-30">
      ...
      <div class="card-body">
          <div class="row">
              ...
              <div class="col-lg-4 col-sm-6 col-md-4">
                  <div class="single-friends-box d-flex align-items-center">
                      <img src="assets/img/user7.jpg" alt="image">
              ...
              <div class="col-lg-4 col-sm-6 col-md-4">
                  <div class="single-friends-box d-flex align-items-center">
                      <img src="assets/img/user8.jpg" alt="image">
              ...
              <div class="col-lg-4 col-sm-6 col-md-4">
                  <div class="single-friends-box d-flex align-items-center">
                      <img src="assets/img/user9.jpg" alt="image">
